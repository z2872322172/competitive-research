...
function getLifecycleStatus(type) {
...
function formatOutputSummary(outputSummary) {
...
function buildRunPlaceholder(latestRun) {
  const placeholder = RUN_PLACEHOLDERS[latestRun?.status]
...
export function buildResearchWorkbenchSummary(events, counts = {}, latestRun = null) {
...
export function buildAuditEvents(events) {
