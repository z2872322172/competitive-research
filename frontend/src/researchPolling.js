...
const TERMINAL_RUN_STATUSES = new Set(['waiting_review', 'completed', 'failed', 'canceled'])
...
function latestRunStatus(detail) {
...
export function shouldPollResearchTask(detail = null) {
...
export function buildResearchSyncFeedback({ detail = null, events = [], error = null } = {}) {
  if (error) {
